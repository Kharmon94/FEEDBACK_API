...
# Install packages needed for deployment (libpq5 for PostgreSQL when DATABASE_URL is set)
RUN apt-get update -qq && \
    apt-get install --no-install-recommends -y curl libsqlite3-0 libpq5 libvips && \
